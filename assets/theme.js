    ...
    CartForm.prototype = Object.assign({}, CartForm.prototype, {
      ...
      cartMarkup: function (html) {
        ...
        $(".ctm_upsell_product_list > [data-main-id]").each(function (e) {
          ...
          if (_speaker == 0) {
            $(
              '.ctm_upsell_product_list > div[data-prod-id="7692896108741"]',
            ).hide();
            $(
              '.ctm_upsell_product_list > div[data-prod-id="7692897157317"]',
            ).hide();
...
$(document).on("click", ".add_6mos_membership_qr", function (e) {
  ...
  $.getJSON("/cart.js", function (cart) {
    ...
    $.ajax({
      ...
      success: function (data) {
        $(".add_6mos_membership_qr").removeClass("btn--loading");
        $(".add_6mos_membership_qr").text(
          "Redirecting to checkout".toUpperCase(),
        );
  ...
  $.getJSON("/cart.js", function (cart) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $(".rainmakerPreOrderUpsell_lp").text(
          "Redirecting to checkout".toUpperCase(),
        );
